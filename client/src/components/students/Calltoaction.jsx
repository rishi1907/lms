...
const Calltoaction = () => {
  return (
    <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0'>
      ...
      <p className='text-gray-500 sm:text-sm'>Incidents are felt, bringing desire. Dedicated to the mind, life moves forward, allowing excellence, except comfort is given.</p>
