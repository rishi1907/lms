  ...
  return (
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
              ...
              {!chapter.collapsed && (
                <div className='p-4'>
                  ...
                  <div onClick={() => handleLecture('add', chapter.chapterId)}
                    className='inline-flex bg-gray-100 p-2 rounded cursor-pointer mt-2'>+ Add Lectures</div>
                </div>
              )}
            </div>
          ))}
        ...
        <button type='submit' className='bg-black text-white w-max py-2.5 px-8 rounded my-4'>Submit</button>
      </form>
    </div>
  );
};
